...
public abstract class BaseShiTiLei  implements Serializable,Comparable<Object> ,EntityI {
	...
	// 集合：字段集合 （zds）
	private java.util.Set<com.poweruniverse.nim.data.entity.system.ZiDuan> zds = new java.util.TreeSet<com.poweruniverse.nim.data.entity.system.ZiDuan>();
	public java.util.Set<com.poweruniverse.nim.data.entity.system.ZiDuan> getZds(){return this.zds ;}
	public void setZds(java.util.Set<com.poweruniverse.nim.data.entity.system.ZiDuan> zds){this.zds = zds;}
	public void addTozds(Object parent,Object detail){
		com.poweruniverse.nim.data.entity.system.ShiTiLei mainObj = (com.poweruniverse.nim.data.entity.system.ShiTiLei)parent;
		com.poweruniverse.nim.data.entity.system.ZiDuan subObj = (com.poweruniverse.nim.data.entity.system.ZiDuan)detail;
	...
	public Object getzdsById(Object id){
		java.util.Iterator<com.poweruniverse.nim.data.entity.system.ZiDuan> ds = this.getZds().iterator();
		com.poweruniverse.nim.data.entity.system.ZiDuan d = null;
		while(ds.hasNext()){
			d = ds.next();
	...
	public com.poweruniverse.nim.data.entity.system.ZiDuan newzdsByParent(com.poweruniverse.nim.data.entity.system.ShiTiLei parent) throws Exception{
		com.poweruniverse.nim.data.entity.system.ZiDuan subObj = new com.poweruniverse.nim.data.entity.system.ZiDuan();
		//
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.poweruniverse.nim.data.entity.system.ShiTiLei)) return false;
		else {
			com.poweruniverse.nim.data.entity.system.ShiTiLei entity = (com.poweruniverse.nim.data.entity.system.ShiTiLei) obj;
	...
	public int compareTo(Object o) {
		com.poweruniverse.nim.data.entity.system.ShiTiLei obj = (com.poweruniverse.nim.data.entity.system.ShiTiLei)o;
	...
	public com.poweruniverse.nim.data.entity.system.ShiTiLei clone(){
		com.poweruniverse.nim.data.entity.system.ShiTiLei shiTiLei = new com.poweruniverse.nim.data.entity.system.ShiTiLei();
		...
		for(com.poweruniverse.nim.data.entity.system.ZiDuan subObj:this.getZds()){
