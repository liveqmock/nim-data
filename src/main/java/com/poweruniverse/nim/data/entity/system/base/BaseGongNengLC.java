...
public abstract class BaseGongNengLC  implements Serializable,Comparable<Object> ,EntityI {
	...
	// 集合：流程明细集合 （mxs）
	private java.util.Set<com.poweruniverse.nim.data.entity.system.GongNengLCMX> mxs = new java.util.TreeSet<com.poweruniverse.nim.data.entity.system.GongNengLCMX>();
	public java.util.Set<com.poweruniverse.nim.data.entity.system.GongNengLCMX> getMxs(){return this.mxs ;}
	public void setMxs(java.util.Set<com.poweruniverse.nim.data.entity.system.GongNengLCMX> mxs){this.mxs = mxs;}
	public void addTomxs(Object parent,Object detail){
		com.poweruniverse.nim.data.entity.system.GongNengLC mainObj = (com.poweruniverse.nim.data.entity.system.GongNengLC)parent;
		com.poweruniverse.nim.data.entity.system.GongNengLCMX subObj = (com.poweruniverse.nim.data.entity.system.GongNengLCMX)detail;
	...
	public Object getmxsById(Object id){
		java.util.Iterator<com.poweruniverse.nim.data.entity.system.GongNengLCMX> ds = this.getMxs().iterator();
		com.poweruniverse.nim.data.entity.system.GongNengLCMX d = null;
		while(ds.hasNext()){
			d = ds.next();
	...
	public com.poweruniverse.nim.data.entity.system.GongNengLCMX newmxsByParent(com.poweruniverse.nim.data.entity.system.GongNengLC parent) throws Exception{
		com.poweruniverse.nim.data.entity.system.GongNengLCMX subObj = new com.poweruniverse.nim.data.entity.system.GongNengLCMX();
		//
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.poweruniverse.nim.data.entity.system.GongNengLC)) return false;
		else {
			com.poweruniverse.nim.data.entity.system.GongNengLC entity = (com.poweruniverse.nim.data.entity.system.GongNengLC) obj;
	...
	public int compareTo(Object o) {
		com.poweruniverse.nim.data.entity.system.GongNengLC obj = (com.poweruniverse.nim.data.entity.system.GongNengLC)o;
	...
	public com.poweruniverse.nim.data.entity.system.GongNengLC clone(){
		com.poweruniverse.nim.data.entity.system.GongNengLC gongNengLC = new com.poweruniverse.nim.data.entity.system.GongNengLC();
		
		for(com.poweruniverse.nim.data.entity.system.GongNengLCMX subObj:this.getMxs()){
