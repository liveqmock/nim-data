...
import com.poweruniverse.nim.data.entity.system.base.BaseGongNeng;
...
public class GongNeng  extends BaseGongNeng  { 
	...
	public static GongNeng getGongNengByDH(String gndh){
		GongNeng gn = null;
		if(gndh!=null){
			Criteria criteria = HibernateSessionFactory.getSession().createCriteria(GongNeng.class)
	...
	public static GongNeng getOperationGNBySTL(ShiTiLei stl,String caoZuoDH){
		Criteria criteria = HibernateSessionFactory.getSession().createCriteria(GongNengCZ.class)
