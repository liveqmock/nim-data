...
public abstract class BaseYongHu  implements Serializable,Comparable<Object> ,EntityI {
	...
	// 对象：用户状态 （yongHuZT）
	private com.poweruniverse.nim.data.entity.system.YongHuZT yongHuZT;
	public com.poweruniverse.nim.data.entity.system.YongHuZT getYongHuZT(){return this.yongHuZT ;}
	public void setYongHuZT(com.poweruniverse.nim.data.entity.system.YongHuZT yongHuZT){this.yongHuZT = yongHuZT;}

	// 集合：角色集合 （jss）
	private java.util.Set<com.poweruniverse.nim.data.entity.system.YongHuJS> jss = new java.util.TreeSet<com.poweruniverse.nim.data.entity.system.YongHuJS>();
	public java.util.Set<com.poweruniverse.nim.data.entity.system.YongHuJS> getJss(){return this.jss ;}
	public void setJss(java.util.Set<com.poweruniverse.nim.data.entity.system.YongHuJS> jss){this.jss = jss;}
	public void addTojss(Object parent,Object detail){
		com.poweruniverse.nim.data.entity.system.YongHu mainObj = (com.poweruniverse.nim.data.entity.system.YongHu)parent;
		com.poweruniverse.nim.data.entity.system.YongHuJS subObj = (com.poweruniverse.nim.data.entity.system.YongHuJS)detail;
	...
	public Object getjssById(Object id){
		java.util.Iterator<com.poweruniverse.nim.data.entity.system.YongHuJS> ds = this.getJss().iterator();
		com.poweruniverse.nim.data.entity.system.YongHuJS d = null;
		while(ds.hasNext()){
			d = ds.next();
	...
	public com.poweruniverse.nim.data.entity.system.YongHuJS newjssByParent(com.poweruniverse.nim.data.entity.system.YongHu parent) throws Exception{
		com.poweruniverse.nim.data.entity.system.YongHuJS subObj = new com.poweruniverse.nim.data.entity.system.YongHuJS();
		//
	...
	// 对象：所属部门 （buMen）
	private com.poweruniverse.nim.data.entity.system.BuMen buMen;
	public com.poweruniverse.nim.data.entity.system.BuMen getBuMen(){return this.buMen ;}
	public void setBuMen(com.poweruniverse.nim.data.entity.system.BuMen buMen){this.buMen = buMen;}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.poweruniverse.nim.data.entity.system.YongHu)) return false;
		else {
			com.poweruniverse.nim.data.entity.system.YongHu entity = (com.poweruniverse.nim.data.entity.system.YongHu) obj;
	...
	public int compareTo(Object o) {
		com.poweruniverse.nim.data.entity.system.YongHu obj = (com.poweruniverse.nim.data.entity.system.YongHu)o;
	...
	public com.poweruniverse.nim.data.entity.system.YongHu clone(){
		com.poweruniverse.nim.data.entity.system.YongHu yongHu = new com.poweruniverse.nim.data.entity.system.YongHu();
		...
		for(com.poweruniverse.nim.data.entity.system.YongHuJS subObj:this.getJss()){
