...
public abstract class BaseJueSeQXGNCZMXGS  implements Serializable,Comparable<Object> ,EntityI {
	...
	private com.poweruniverse.nim.data.entity.sys.JueSeQXGNCZMX jueSeQXMX;
	public com.poweruniverse.nim.data.entity.sys.JueSeQXGNCZMX getJueSeQXMX(){return this.jueSeQXMX ;}
	public void setJueSeQXMX(com.poweruniverse.nim.data.entity.sys.JueSeQXGNCZMX jueSeQXMX){this.jueSeQXMX = jueSeQXMX;}

	public boolean equals (Object obj) {
		if (null == obj) return false;
		if (!(obj instanceof com.poweruniverse.nim.data.entity.sys.JueSeQXGNCZMXGS)) return false;
		else {
			com.poweruniverse.nim.data.entity.sys.JueSeQXGNCZMXGS entity = (com.poweruniverse.nim.data.entity.sys.JueSeQXGNCZMXGS) obj;
	...
	public int compareTo(Object o) {
		com.poweruniverse.nim.data.entity.sys.JueSeQXGNCZMXGS obj = (com.poweruniverse.nim.data.entity.sys.JueSeQXGNCZMXGS)o;
	...
	public com.poweruniverse.nim.data.entity.sys.JueSeQXGNCZMXGS clone(){
		com.poweruniverse.nim.data.entity.sys.JueSeQXGNCZMXGS jueSeQXGNCZMXGS = new com.poweruniverse.nim.data.entity.sys.JueSeQXGNCZMXGS();
