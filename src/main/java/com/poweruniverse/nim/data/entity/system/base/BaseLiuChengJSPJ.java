...
public abstract class BaseLiuChengJSPJ  implements Serializable,Comparable<Object> ,EntityI {
	...
	private com.poweruniverse.nim.data.entity.system.LiuChengJS pingJiLCJS;
	public com.poweruniverse.nim.data.entity.system.LiuChengJS getPingJiLCJS(){return this.pingJiLCJS ;}
	public void setPingJiLCJS(com.poweruniverse.nim.data.entity.system.LiuChengJS pingJiLCJS){this.pingJiLCJS = pingJiLCJS;}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.poweruniverse.nim.data.entity.system.LiuChengJSPJ)) return false;
		else {
			com.poweruniverse.nim.data.entity.system.LiuChengJSPJ entity = (com.poweruniverse.nim.data.entity.system.LiuChengJSPJ) obj;
	...
	public int compareTo(Object o) {
		com.poweruniverse.nim.data.entity.system.LiuChengJSPJ obj = (com.poweruniverse.nim.data.entity.system.LiuChengJSPJ)o;
	...
	public com.poweruniverse.nim.data.entity.system.LiuChengJSPJ clone(){
		com.poweruniverse.nim.data.entity.system.LiuChengJSPJ liuChengJSPJ = new com.poweruniverse.nim.data.entity.system.LiuChengJSPJ();
