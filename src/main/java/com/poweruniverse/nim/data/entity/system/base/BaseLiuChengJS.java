...
public abstract class BaseLiuChengJS  implements Serializable,Comparable<Object> ,EntityI {
	...
	// 集合：上级集合 （sjs）
	private java.util.Set<com.poweruniverse.nim.data.entity.system.LiuChengJSSJ> sjs = new java.util.TreeSet<com.poweruniverse.nim.data.entity.system.LiuChengJSSJ>();
	public java.util.Set<com.poweruniverse.nim.data.entity.system.LiuChengJSSJ> getSjs(){return this.sjs ;}
	public void setSjs(java.util.Set<com.poweruniverse.nim.data.entity.system.LiuChengJSSJ> sjs){this.sjs = sjs;}
	public void addTosjs(Object parent,Object detail){
		com.poweruniverse.nim.data.entity.system.LiuChengJS mainObj = (com.poweruniverse.nim.data.entity.system.LiuChengJS)parent;
		com.poweruniverse.nim.data.entity.system.LiuChengJSSJ subObj = (com.poweruniverse.nim.data.entity.system.LiuChengJSSJ)detail;
	...
	public Object getsjsById(Object id){
		java.util.Iterator<com.poweruniverse.nim.data.entity.system.LiuChengJSSJ> ds = this.getSjs().iterator();
		com.poweruniverse.nim.data.entity.system.LiuChengJSSJ d = null;
		while(ds.hasNext()){
			d = ds.next();
	...
	public com.poweruniverse.nim.data.entity.system.LiuChengJSSJ newsjsByParent(com.poweruniverse.nim.data.entity.system.LiuChengJS parent) throws Exception{
		com.poweruniverse.nim.data.entity.system.LiuChengJSSJ subObj = new com.poweruniverse.nim.data.entity.system.LiuChengJSSJ();
		//
	...
	// 集合：下级集合 （xjs）
	private java.util.Set<com.poweruniverse.nim.data.entity.system.LiuChengJSXJ> xjs = new java.util.TreeSet<com.poweruniverse.nim.data.entity.system.LiuChengJSXJ>();
	public java.util.Set<com.poweruniverse.nim.data.entity.system.LiuChengJSXJ> getXjs(){return this.xjs ;}
	public void setXjs(java.util.Set<com.poweruniverse.nim.data.entity.system.LiuChengJSXJ> xjs){this.xjs = xjs;}
	public void addToxjs(Object parent,Object detail){
		com.poweruniverse.nim.data.entity.system.LiuChengJS mainObj = (com.poweruniverse.nim.data.entity.system.LiuChengJS)parent;
		com.poweruniverse.nim.data.entity.system.LiuChengJSXJ subObj = (com.poweruniverse.nim.data.entity.system.LiuChengJSXJ)detail;
		subObj.setLiuChengJS(mainObj);
	...
	public Object getxjsById(Object id){
		java.util.Iterator<com.poweruniverse.nim.data.entity.system.LiuChengJSXJ> ds = this.getXjs().iterator();
		com.poweruniverse.nim.data.entity.system.LiuChengJSXJ d = null;
		while(ds.hasNext()){
			d = ds.next();
	...
	public com.poweruniverse.nim.data.entity.system.LiuChengJSXJ newxjsByParent(com.poweruniverse.nim.data.entity.system.LiuChengJS parent) throws Exception{
		com.poweruniverse.nim.data.entity.system.LiuChengJSXJ subObj = new com.poweruniverse.nim.data.entity.system.LiuChengJSXJ();
		//
		subObj.setLiuChengJS(parent);
		//
		return subObj;
	...
	// 集合：平级集合 （pjs）
	private java.util.Set<com.poweruniverse.nim.data.entity.system.LiuChengJSPJ> pjs = new java.util.TreeSet<com.poweruniverse.nim.data.entity.system.LiuChengJSPJ>();
	public java.util.Set<com.poweruniverse.nim.data.entity.system.LiuChengJSPJ> getPjs(){return this.pjs ;}
	public void setPjs(java.util.Set<com.poweruniverse.nim.data.entity.system.LiuChengJSPJ> pjs){this.pjs = pjs;}
	public void addTopjs(Object parent,Object detail){
		com.poweruniverse.nim.data.entity.system.LiuChengJS mainObj = (com.poweruniverse.nim.data.entity.system.LiuChengJS)parent;
		com.poweruniverse.nim.data.entity.system.LiuChengJSPJ subObj = (com.poweruniverse.nim.data.entity.system.LiuChengJSPJ)detail;
		subObj.setLiuChengJS(mainObj);
	...
	public Object getpjsById(Object id){
		java.util.Iterator<com.poweruniverse.nim.data.entity.system.LiuChengJSPJ> ds = this.getPjs().iterator();
		com.poweruniverse.nim.data.entity.system.LiuChengJSPJ d = null;
		while(ds.hasNext()){
			d = ds.next();
	...
	public com.poweruniverse.nim.data.entity.system.LiuChengJSPJ newpjsByParent(com.poweruniverse.nim.data.entity.system.LiuChengJS parent) throws Exception{
		com.poweruniverse.nim.data.entity.system.LiuChengJSPJ subObj = new com.poweruniverse.nim.data.entity.system.LiuChengJSPJ();
		//
		subObj.setLiuChengJS(parent);
		//
		return subObj;
	...
	// 集合：流程变量集合 （bls）
	private java.util.Set<com.poweruniverse.nim.data.entity.system.LiuChengJSBL> bls = new java.util.TreeSet<com.poweruniverse.nim.data.entity.system.LiuChengJSBL>();
	public java.util.Set<com.poweruniverse.nim.data.entity.system.LiuChengJSBL> getBls(){return this.bls ;}
	public void setBls(java.util.Set<com.poweruniverse.nim.data.entity.system.LiuChengJSBL> bls){this.bls = bls;}
	public void addTobls(Object parent,Object detail){
		com.poweruniverse.nim.data.entity.system.LiuChengJS mainObj = (com.poweruniverse.nim.data.entity.system.LiuChengJS)parent;
		com.poweruniverse.nim.data.entity.system.LiuChengJSBL subObj = (com.poweruniverse.nim.data.entity.system.LiuChengJSBL)detail;
		subObj.setLiuChengJS(mainObj);
	...
	public Object getblsById(Object id){
		java.util.Iterator<com.poweruniverse.nim.data.entity.system.LiuChengJSBL> ds = this.getBls().iterator();
		com.poweruniverse.nim.data.entity.system.LiuChengJSBL d = null;
		while(ds.hasNext()){
			d = ds.next();
	...
	public com.poweruniverse.nim.data.entity.system.LiuChengJSBL newblsByParent(com.poweruniverse.nim.data.entity.system.LiuChengJS parent) throws Exception{
		com.poweruniverse.nim.data.entity.system.LiuChengJSBL subObj = new com.poweruniverse.nim.data.entity.system.LiuChengJSBL();
		//
		subObj.setLiuChengJS(parent);
		//
		return subObj;
	...
	// 对象：用户 （wanChengYH）
	private com.poweruniverse.nim.data.entity.system.YongHu wanChengYH;
	public com.poweruniverse.nim.data.entity.system.YongHu getWanChengYH(){return this.wanChengYH ;}
	public void setWanChengYH(com.poweruniverse.nim.data.entity.system.YongHu wanChengYH){this.wanChengYH = wanChengYH;}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.poweruniverse.nim.data.entity.system.LiuChengJS)) return false;
		else {
			com.poweruniverse.nim.data.entity.system.LiuChengJS entity = (com.poweruniverse.nim.data.entity.system.LiuChengJS) obj;
	...
	public int compareTo(Object o) {
		com.poweruniverse.nim.data.entity.system.LiuChengJS obj = (com.poweruniverse.nim.data.entity.system.LiuChengJS)o;
	...
	public com.poweruniverse.nim.data.entity.system.LiuChengJS clone(){
		com.poweruniverse.nim.data.entity.system.LiuChengJS liuChengJS = new com.poweruniverse.nim.data.entity.system.LiuChengJS();
		...
		for(com.poweruniverse.nim.data.entity.system.LiuChengJSSJ subObj:this.getSjs()){
			liuChengJS.addTosjs(liuChengJS, subObj.clone());
		}
		for(com.poweruniverse.nim.data.entity.system.LiuChengJSXJ subObj:this.getXjs()){
		...
		for(com.poweruniverse.nim.data.entity.system.LiuChengJSPJ subObj:this.getPjs()){
			liuChengJS.addTopjs(liuChengJS, subObj.clone());
		}
		liuChengJS.setCaoZuoXX(caoZuoXX);
		for(com.poweruniverse.nim.data.entity.system.LiuChengJSBL subObj:this.getBls()){
