...
public abstract class BaseYongHuZT  implements Serializable,Comparable<Object> ,EntityI {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.poweruniverse.nim.data.entity.sys.YongHuZT)) return false;
		else {
			com.poweruniverse.nim.data.entity.sys.YongHuZT entity = (com.poweruniverse.nim.data.entity.sys.YongHuZT) obj;
	...
	public int compareTo(Object o) {
		com.poweruniverse.nim.data.entity.sys.YongHuZT obj = (com.poweruniverse.nim.data.entity.sys.YongHuZT)o;
	...
	public com.poweruniverse.nim.data.entity.sys.YongHuZT clone(){
		com.poweruniverse.nim.data.entity.sys.YongHuZT yongHuZT = new com.poweruniverse.nim.data.entity.sys.YongHuZT();
