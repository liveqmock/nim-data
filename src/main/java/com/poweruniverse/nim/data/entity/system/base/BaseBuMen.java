...
public abstract class BaseBuMen  implements Serializable,Comparable<Object> ,EntityI {
	...
	// 对象：上级部门 （shangJiBM）
	private com.poweruniverse.nim.data.entity.system.BuMen shangJiBM;
	public com.poweruniverse.nim.data.entity.system.BuMen getShangJiBM(){return this.shangJiBM ;}
	public void setShangJiBM(com.poweruniverse.nim.data.entity.system.BuMen shangJiBM){this.shangJiBM = shangJiBM;}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.poweruniverse.nim.data.entity.system.BuMen)) return false;
		else {
			com.poweruniverse.nim.data.entity.system.BuMen entity = (com.poweruniverse.nim.data.entity.system.BuMen) obj;
	...
	public int compareTo(Object o) {
		com.poweruniverse.nim.data.entity.system.BuMen obj = (com.poweruniverse.nim.data.entity.system.BuMen)o;
	...
	public com.poweruniverse.nim.data.entity.system.BuMen clone(){
		com.poweruniverse.nim.data.entity.system.BuMen buMen = new com.poweruniverse.nim.data.entity.system.BuMen();
