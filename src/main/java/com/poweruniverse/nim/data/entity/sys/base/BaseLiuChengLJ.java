...
public abstract class BaseLiuChengLJ  implements Serializable,Comparable<Object> ,EntityI {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.poweruniverse.nim.data.entity.sys.LiuChengLJ)) return false;
		else {
			com.poweruniverse.nim.data.entity.sys.LiuChengLJ entity = (com.poweruniverse.nim.data.entity.sys.LiuChengLJ) obj;
	...
	public int compareTo(Object o) {
		com.poweruniverse.nim.data.entity.sys.LiuChengLJ obj = (com.poweruniverse.nim.data.entity.sys.LiuChengLJ)o;
	...
	public com.poweruniverse.nim.data.entity.sys.LiuChengLJ clone(){
		com.poweruniverse.nim.data.entity.sys.LiuChengLJ liuChengLJ = new com.poweruniverse.nim.data.entity.sys.LiuChengLJ();
